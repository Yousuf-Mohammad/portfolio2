...
const About = () => {
  ...
  return (
    <motion.section className="w-full min-h-screen bg-slate-900 bg-[radial-gradient(#ffffff_1px,#00091d_1px)] bg-[size:20px_20px] lg:rounded-3xl px-4 sm:px-6 lg:px-8 py-8  xl:sticky relative xl:top-0 ">
      <div className="grid grid-cols-1 lg:grid-cols-10 lg:grid-rows-6 gap-4 max-w-7xl mx-auto">
        ...
        <BentoCard className="lg:col-span-7 lg:row-span-3 row-span-2 bg-gray-800 p-4 md:p-6 lg:justify-center ">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-normal leading-relaxed mt-2 md:mt-4 text-stroke">
            With a strong enthusiasm for web development, I continuously seek
            opportunities to expand my skill set and stay updated with the
            latest industry trends. My goal is to craft innovative digital
        ...
        <BentoCard className="lg:col-span-4 lg:row-span-3 row-span-2 bg-gray-800 p-3 ">
          <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-center uppercase mb-4 text-stroke ">
            I have worked using
          </h1>
        ...
        <BentoCard className="lg:col-span-3 lg:row-span-3 row-span-2 bg-gray-800 p-4 md:p-6 w-full">
          <h1 className="text-xl md:text-2xl lg:text-3xl font-bold uppercase  text-center mb-4 text-stroke">
            Experience
          </h1>
          {experiences.map((exp) => (
            <div key={exp.company} className="flex items-start gap-3 mb-4 ">
              ...
              <div className="w-full">
                <p className="w-full text-sm sm:text-base md:text-base font-semibold">
                  {exp.role}
                </p>
                <p className="w-full text-xs sm:text-sm md:text-sm text-gray-300">
